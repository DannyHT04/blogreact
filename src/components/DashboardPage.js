...
export default function Dashboard() {
  ...
  const [isLoading, setLoadingBool] = useState(true);
  ...
  return (
    <Container>
      ...
      <Row>
        <Col md={12}>
          <Button onClick={(e) => handleShow(e,{id: 0, userId: blogUserId, publisherName: blogPublisherName, title:"", description:"", category:"", tags:"", isDeleted: false, isPublished: false})}>Add Blog Item</Button>
      ...
      <Row>
        <Col className="mt-5">
          {/* If there are blog items display accorddian  */}
          {isLoading ? (
            // Loading screen here
            <h1>
            ...
            <h1>No Blog Items, Add Blog Items Above</h1>
          ) : (
